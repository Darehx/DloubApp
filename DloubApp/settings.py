"""
Django settings for DloubApp project.
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'driver': 'ODBC Driver 17 for SQL Server', # Ajusta según tu versión
            'Trusted_Connection': 'yes', # Clave para autenticación de Windows
        },
    }
}
